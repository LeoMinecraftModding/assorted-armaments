...
public class AAItems {
	...
	// pikes
	public static final DeferredItem<PikeItem> WOODEN_PIKE = ITEMS.register("wooden_pike", () -> new PikeItem(Tiers.WOOD, new Item.Properties().attributes(PikeItem.createAttributes(Tiers.WOOD, 3.5f, -2.8f))));
	public static final DeferredItem<PikeItem> STONE_PIKE = ITEMS.register("stone_pike", () -> new PikeItem(Tiers.STONE, new Item.Properties().attributes(PikeItem.createAttributes(Tiers.STONE, 3.5f, -2.8f))));
	public static final DeferredItem<PikeItem> IRON_PIKE = ITEMS.register("iron_pike", () -> new PikeItem(Tiers.IRON, new Item.Properties().attributes(PikeItem.createAttributes(Tiers.IRON, 3.5f, -2.8f))));
	public static final DeferredItem<PikeItem> GOLDEN_PIKE = ITEMS.register("golden_pike", () -> new PikeItem(Tiers.GOLD, new Item.Properties().attributes(PikeItem.createAttributes(Tiers.GOLD, 3.5f, -2.8f))));
	public static final DeferredItem<PikeItem> DIAMOND_PIKE = ITEMS.register("diamond_pike", () -> new PikeItem(Tiers.DIAMOND, new Item.Properties().attributes(PikeItem.createAttributes(Tiers.DIAMOND, 4f, -2.8f))));
	public static final DeferredItem<PikeItem> NETHERITE_PIKE = ITEMS.register("netherite_pike", () -> new PikeItem(Tiers.NETHERITE, new Item.Properties().attributes(PikeItem.createAttributes(Tiers.NETHERITE, 4f, -2.8f)).fireResistant()));
	...
	public static final DeferredItem<HalberdItem> NETHERITE_HALBERD = ITEMS.register("netherite_halberd", () -> new HalberdItem(Tiers.NETHERITE, new Item.Properties().attributes(HalberdItem.createAttributes(Tiers.NETHERITE, 7f, -3.2f, 1.5f)).fireResistant()));
	...
	public static final DeferredItem<HeavyShieldItem> NETHERITE_HEAVY_SHIELD = ITEMS.register("netherite_heavy_shield", () -> new HeavyShieldItem(Tiers.NETHERITE, new Item.Properties().attributes(HeavyShieldItem.createAttributes(Tiers.NETHERITE, 1.5f, -2.8f)).fireResistant()));

	// claws
	public static final DeferredItem<ClawItem> WOODEN_CLAW = ITEMS.register("wooden_claw", () -> new ClawItem(Tiers.WOOD, new Item.Properties().attributes(HeavyShieldItem.createAttributes(Tiers.WOOD, 2.5f, -1.6f))));
	public static final DeferredItem<ClawItem> STONE_CLAW = ITEMS.register("stone_claw", () -> new ClawItem(Tiers.STONE, new Item.Properties().attributes(HeavyShieldItem.createAttributes(Tiers.STONE, 3f, -1.6f))));
	public static final DeferredItem<ClawItem> IRON_CLAW = ITEMS.register("iron_claw", () -> new ClawItem(Tiers.IRON, new Item.Properties().attributes(HeavyShieldItem.createAttributes(Tiers.IRON, 3.5f, -1.6f))));
	public static final DeferredItem<ClawItem> GOLDEN_CLAW = ITEMS.register("golden_claw", () -> new ClawItem(Tiers.GOLD, new Item.Properties().attributes(HeavyShieldItem.createAttributes(Tiers.GOLD, 2.5f, -1.6f))));
	public static final DeferredItem<ClawItem> DIAMOND_CLAW = ITEMS.register("diamond_claw", () -> new ClawItem(Tiers.DIAMOND, new Item.Properties().attributes(HeavyShieldItem.createAttributes(Tiers.DIAMOND, 4f, -1.6f))));
	public static final DeferredItem<ClawItem> NETHERITE_CLAW = ITEMS.register("netherite_claw", () -> new ClawItem(Tiers.NETHERITE, new Item.Properties().attributes(HeavyShieldItem.createAttributes(Tiers.NETHERITE, 5f, -1.6f)).fireResistant()));
}
